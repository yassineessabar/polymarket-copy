    ...
    <div className="max-w-[700px] mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#9B9B9B] font-mono">{walletDisplay}</p>
            </div>
          </div>
          <button
            onClick={copyWallet}
            className="text-xs font-medium text-[#121212] bg-[#F7F7F7] border border-black/5 rounded-full px-4 py-2 hover:bg-[#EBEBEB] transition-colors"
          >
            {copied ? "Copied!" : "Copy"}
          </button>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm mb-4 overflow-hidden">
        ...
        >
          ...
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#BFBFBF" strokeWidth="2" className={`transition-transform ${showKey ? "rotate-90" : ""}`}><path d="m9 18 6-6-6-6"/></svg>
        </button>
        {showKey && (
          <div className="px-5 pb-5 border-t border-black/5">
            ...
            <div className="bg-[#F7F7F7] rounded-xl px-4 py-3 font-mono text-xs break-all text-[#121212] mb-3">
              {profile?.private_key || profile?.auth_wallet || "Your private key is securely stored. Contact support to export."}
            </div>
            <button
              onClick={copyPrivateKey}
              className="bg-[#121212] hover:bg-[#333] text-white text-xs font-medium px-5 py-2 rounded-full transition-colors"
            >
      ...
      <div className="bg-white rounded-2xl shadow-sm mb-4 overflow-hidden">
        ...
        >
          ...
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#BFBFBF" strokeWidth="2" className={`transition-transform ${showHelp ? "rotate-90" : ""}`}><path d="m9 18 6-6-6-6"/></svg>
        </button>
        {showHelp && (
      ...
      {/* Join the Community */}
      <a href="https://t.me/polycoolapp" target="_blank" rel="noopener noreferrer" className="bg-white rounded-2xl shadow-sm flex items-center gap-3 px-5 py-4 mb-4 hover:bg-[#F7F7F7] transition-colors">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#9B9B9B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <line x1="22" y1="2" x2="11" y2="13" /><polygon points="22 2 15 22 11 13 2 9 22 2" />
        </svg>
        <span className="flex-1 text-sm font-medium text-[#121212]">Join the Community</span>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#BFBFBF" strokeWidth="2"><path d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6M15 3h6v6M10 14L21 3"/></svg>
      </a>
